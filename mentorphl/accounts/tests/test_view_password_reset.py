...
#        self.assertIsInstance(view.func.view_class, UserPasswordResetView)
...
#        self.assertEquals(view.func.view_class, UserPasswordResetDoneView)
...
#        self.assertEquals(view.func.view_class, UserPasswordResetConfirmView)
...
#        self.assertEquals(view.func.view_class, UserPasswordResetCompleteView)